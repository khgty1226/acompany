package com.bteam.proj.attach.web;
...
public class AttachController {
	...
	//proj/uploads/summernote_image/2403de57-53be-485a-81a1-1ff5bd177743.jpg
	...
	@RequestMapping(value ="/uploads/{filePath}/{fileName:.+}" )
	@ResponseBody
	//public ResponseEntity<byte[]> uploads (@PathVariable("filePath") String filePath, @PathVariable("fileName") String fileName  ) {
	public byte[] uploads (@PathVariable("filePath") String filePath, @PathVariable("fileName") String fileName  ) {
