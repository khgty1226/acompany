package com.bteam.proj.reply.vo;
...
public class ReplyVO {
	...
	public String toString() {
		return "ReplyVO [reNo=" + reNo + ", reCategory=" + reCategory + ", reParentNo=" + reParentNo + ", memNo="
				+ memNo + ", reContent=" + reContent + ", reIp=" + reIp + ", reRegDate=" + reRegDate + "]";
	}
