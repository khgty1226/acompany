...
public class KakaoPayApproveVO {
	...
	public String toString() {
		return "KakaoPayApproveVO [aid=" + aid + ", tid=" + tid + ", cid=" + cid + ", sid=" + sid
				...
				+ ", approved_at=" + approved_at + ", payload=" + payload + ", cartNoStr=" + cartNoStr + ", memMileage="
				+ memMileage + ", memNo=" + memNo + ", prodNo=" + prodNo + ", prodCnt=" + prodCnt + "]";
	}
