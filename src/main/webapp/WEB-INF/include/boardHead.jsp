...
function fn_boardViewCode(boardCode){
	...
	location.href="${pageContext.request.contextPath}/boardNoticeView?boardCode="+bc+"&searchType="+st+"&searchWord="+sw+"&rowSizePerPage="+rpp;
		...
		<!-- 게시판 상단 카테고리 버튼 -->
 		<div class="sub_btn wow fadeInUp" data-wow-delay="0.1s">
			<c:forEach items="${boardInfoList}" var="boardInfo">
				...
				onclick="fn_boardViewCode('${boardInfo.boardCode}')">${boardInfo.boardCategoryName}</a>
