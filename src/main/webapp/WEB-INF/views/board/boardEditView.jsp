...
<body id="page-top">
	...
	<section class="page-section mt-5" id="contact">
		<div class="container col-5">
			...
			<h2 class="maintit d-flex justify-content-start">E D I T</h2>
			...
			<input name="boardNo" type="hidden" value="${board.boardNo }" />
				<div class="form-group">
					<div class="form-group">
						...
						<input type="text" class="form-control" name="boardTitle" id="sg_title" value="${board.boardTitle }" required>
					</div>
					<div class="form-group">
						<label for="sg_cate">분류</label> 
						<input type="text" class= form-control name="boardCategory" id="sg_cate" value="${board.boardCategory }" readonly>
					</div>
					<div class="form-group">
						<label for="sg_name">작성자</label> 
						<input type="text" class="form-control" name="memNo" id="sg_name" value="${board.memNo }" readonly>
					</div>
					<div class="form-group">
						<label for="summernote">내용</label>
						<textarea class="summernote" name="boardContent" id="summernote">${board.boardContent }</textarea>
					</div>
